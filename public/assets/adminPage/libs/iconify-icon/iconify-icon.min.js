...
!(function () {
  ...
  function jt(t, e) {
    ...
    let d, h;
    null === a
      ? ((h = null === u ? "1em" : "auto" === u ? f : u), (d = _t(h, l / f)))
      : ((d = "auto" === a ? l : a),
        (h = null === u ? _t(d, f / l) : "auto" === u ? f : u));
    const p = {},
      g = (t, e) => {
        kt(e) || (p[t] = e.toString());
      };
  ...
  function Lt(t, e) {
    let n = Array.from(t.childNodes).find(
      (t) => t.hasAttribute && t.hasAttribute(Tt)
    );
    n ||
      ((n = document.createElement("style")),
      n.setAttribute(Tt, Tt),
      t.appendChild(n)),
      (n.textContent =
  ...
  const Pt = { "background-color": "currentColor" },
    ...
    zt = { image: "var(--svg)", repeat: "no-repeat", size: "100% 100%" },
    Qt = { "-webkit-mask": Pt, mask: Pt, background: Nt };
  for (const t in Qt) {
    const e = Qt[t];
    ...
    if ("svg" === s)
      ...
      c = (function (t, e, n) {
        ...
        const o = t.attributes,
          s = At(Ot(r, { ...o, width: e.width + "", height: e.height + "" })),
          c = i.style,
          a = {
            "--svg": s,
            width: qt(o.width),
      ...
      o = class extends n {
        ...
        constructor() {
          ...
          const t = (this._shadowRoot = this.attachShadow({ mode: "open" })),
            e = mt(this);
          Lt(t, e), (this._state = $t({ value: "" }, e)), this._queueCheck();
        }
        connectedCallback() {
        ...
        _iconChanged(t) {
          ...
          e.data
            ? this._gotIconData(e)
            : (this._state = $t(e, this._state.inline, this._state));
        }
        _forceRender() {
