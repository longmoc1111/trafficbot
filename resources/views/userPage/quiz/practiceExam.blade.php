            ...
            <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                <div class="bg-white rounded-top p-5">
                    ...
                    <div class="mb-2">
                        ...
                        <h5>Bao gồm</h5>
                        <ul>
                            <li>số lượng câu hỏi: <strong style="color:#ff0000">{{ $license->LicenseTypeQuantity }} câu
                                </strong></li>
                            <li>yêu cầu : <strong style="color:#ff0000">đúng
        ...
        <div class="wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item position-relative h-100">
                <div class="service-text rounded p-5">
                    ...
                    <div class="row g-4 mb-3 justify-content-center wow fadeInUp" data-wow-delay="0.1s">
                        <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                            <a href="{{ route('userpage.practice.start.random', ['licenseID' => $license]) }}"
                                class="text-decoration-none w-100 d-block">
                                <div class="testimonial-item rounded text-center p-2 h-100">
                                    <p class="small mb-1 text-dark text-nowrap">Đề ngẫu nhiên</p>
                                </div>
                            </a>
                        </div>
                    </div>

                    <!-- Hàng 2: Các đề trong danh sách -->
                    <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                        @foreach ($examSets as $examSet)
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <a href="{{ route('userpage.practiceStart', ['licenseID' => $license, 'examsetID' => $examSet->ExamSetID]) }}"
                                    class="text-decoration-none w-100 d-block">
                                    <div class="testimonial-item rounded text-center p-2 h-100">
                                        <p class="small mb-1 text-dark">{{ $examSet->ExamSetName }}</p>
                                    </div>
                                </a>
                            </div>
                        @endforeach
