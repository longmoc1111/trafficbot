                    ...
                    <div class="service-item-home position-relative h-100 ">
                        <div class="service-text-home rounded ">
                            ...
                            <div class="btn-container">
                                <a href="{{ route("userpage.practice.test") }}" class="btn-continue text-center">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6 wow fadeInUp " data-wow-delay="0.1s">
                    <div class="service-item-home position-relative h-100 ">
                        <div class="service-text-home rounded ">
                            ...
                            <p class="mb-0 title-content">60 câu điểm liệt về tình huống mất an toàn giao thông nghiêm trọng</p>
                            <hr>
                            <div class="btn-container">
                                <a href="{{ route("userpage.criticalfull") }}" class="btn-continue  text-center">
                                    Tiếp tục <i class="fa fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
