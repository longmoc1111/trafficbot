                ...
                @if($errors->has('sum_questionCategory'))
                    <div class="flex items-center gap-3 bg-red-50 border border-red-200 rounded-md p-4">
                        ...
                        <div class="text-sm text-red-800 font-medium flex-grow">
                            {{ $errors->first('sum_questionCategory') }}
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="LicenseTypeDescription" name="LicenseTypeDescription"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200">{{ old("LicenseTypeDescription") }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="LicenseTypePassCount" name="LicenseTypePassCount"
                                    value="{{ old("LicenseTypePassCount") }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            @foreach ($QuestionCategory as $category)
                                <div>
                                    ...
                                    <input type="number" id="questionCategory_{{ $category->CategoryID }}"
                                        value="{{ old("questionCategory" . $category->CategoryID) }}"
                                        name="questionCategory[{{ $category->CategoryID }}]" placeholder="Số lượng câu hỏi"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200">
                                </div>
                            @endforeach
                        </div>
