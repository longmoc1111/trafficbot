                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                @error('QuestionExplain')
                                    <p class="text-sm text-red-600 bg-red-50 px-2 py-1 rounded mb-1">{{ $message }}</p>
                                @enderror
                                <textarea name="QuestionExplain"
                                    class="form-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200"></textarea>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <!-- Chọn tất cả -->
                                <div
                                    class=" flex justify-center gap-4 bg-gray-50 p-3 rounded-md border border-gray-200 mb-3">
