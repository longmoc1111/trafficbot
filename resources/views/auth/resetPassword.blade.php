					...
					<div class="fxt-content">
						...
						<div class="fxt-form">
							<form action = "{{ route("password.update") }}" method="POST">
								...
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input id="password" type="password" class="form-control" name="password" placeholder="Mật khẩu mới*" required="required">
								...
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input id="confirmPassword" type="password" class="form-control" name="confirmPassword" placeholder="xác nhận mật khẩu mới*" required="required">
								...
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-4">
										<button type="submit" class="fxt-btn-fill">Đặt lại mật khẩu</button>
									</div>
								</div>
							</form>
						</div>
